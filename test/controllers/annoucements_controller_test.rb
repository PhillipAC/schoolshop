...
class AnnoucementsControllerTest < ActionController::TestCase
  ...
  test "should create annoucement" do
    assert_difference('Annoucement.count') do
      post :create, annoucement: { content: @annoucement.content, title: @annoucement.title, user_id: @annoucement.user_id }
    end
  ...
  test "should update annoucement" do
    patch :update, id: @annoucement, annoucement: { content: @annoucement.content, title: @annoucement.title, user_id: @annoucement.user_id }
    assert_redirected_to annoucement_path(assigns(:annoucement))
  end
